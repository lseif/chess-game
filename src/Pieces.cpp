...
Piece::Piece(const bool& color, const Pos& position)
    : color(color)
    , position(position)
    , isMoved(false)
{
...
Piece::Piece(const bool& color, const Pos& position, const bool& isMoved)
    : color(color)
    , position(position)
    , isMoved(isMoved)
{
...
Piece::Piece(const bool& color, const Pos& position, const std::string& symbol)
    : color(color)
    , position(position)
    , isMoved(false)
    , SYMBOL(symbol)
...
Rook::Rook(const bool& c, const Pos& p)
    : Piece(c, p, std::string("R"))
{
}

Knight::Knight(const bool& c, const Pos& p)
    : Piece(c, p, std::string("K"))
{
}

Bishop::Bishop(const bool& c, const Pos& p)
    : Piece(c, p, std::string("B"))
{
}

Queen::Queen(const bool& c, const Pos& p)
    : Piece(c, p, std::string("Q"))
{
}

King::King(const bool& c, const Pos& p)
    : Piece(c, p, std::string("O"))
{
}

Pawn::Pawn(const bool& c, const Pos& p)
    : Piece(c, p, std::string("P"))
{
}
